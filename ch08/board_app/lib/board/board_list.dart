...
// Navigator 페이지 이동 버튼이 있는 게시 글 리스트 페이지
                      ...
                      child: ListTile(
                        ...
                        subtitle: Row(
                          ...
                          children: [
                            ...
                            Text(
                              DateFormat(
                                'yyyy-MM-dd').format(DateTime.parse(bList[i]["regDate"]))),
                          ],
                        ),
